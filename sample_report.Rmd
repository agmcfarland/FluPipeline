...
df_majorvar <- tryCatch(
    ...
    error = function(e){ 
      message('Error reading in Rdata file')
    }
)
...
\small
Table 4: Summary of read coverage and depth for reference strain alignment using a randomized subset of reads.
...
```
\small
Table 5: Per-segment read coverage for reference strain alignment using a randomized subset of reads.
...
Table 6: Per-segment read depth for reference strain alignment using a randomized subset of reads.
